...
<head>
  ...
  <!-- add icon link -->
  <link rel = "icon" type = "image/x-icon" href = "{{asset('images/JMLOGO.png')}}">
...
<div class="wrapper">
  ...
  <header class="main-header" >
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Silvape</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Silvape</b></span>
    </a>
  ...
  <footer class="main-footer">
    <strong>© 2023 SILVAPE | All rights reserved</strong>
  </footer>
