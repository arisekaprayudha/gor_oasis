...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hrmlmsusers', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
        ...
        Schema::table('hrmlmsusers', function(Blueprint $table){
            $table->foreign('unitkerja_id')->references('id')->on('unit_kerjas')->onDelete('cascade')->unUpdate('cascade');
        });

        Schema::create('hrmlmsroles', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('hrmlmsusers');
        Schema::dropIfExists('hrmlmspermissions');
        Schema::dropIfExists('hrmlmsroles');
